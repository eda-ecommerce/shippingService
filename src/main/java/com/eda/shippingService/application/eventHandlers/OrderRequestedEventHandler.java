...
public class OrderRequestedEventHandler implements EventHandler<OrderRequestedEvent> {
    ...
    @Autowired
    public OrderRequestedEventHandler(IdempotentConsumerRepository idempotentConsumerRepository, CreateShipment createShipmentHandler, EventPublisher eventPublisher) {
    ...
    public void handle(OrderRequestedEvent event) {
        ...
        // Transforming this from event to DTO seems counterintuitive, should the handler support taking events directly?
